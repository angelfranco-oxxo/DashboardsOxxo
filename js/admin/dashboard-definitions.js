...
window.OXXO_ADMIN_DASHBOARDS = function createAdminDashboards(deps){
  ...
  return [
    ...
    {key:'inventories',label:'Comercial - Inventarios',tab:OXXO.SHEETS_CONFIG.TABS.inventories,periodColumn:'Periodo',preferredSheets:['Resultado de Inventario'],output:['Periodo','#','CR','Tienda','Plaza','Asesor Comercial','Fecha de Inventario Anterior','Fecha de Inventario','# Días de Inventario','Resultado de Inventario','Resultado del Mes Actual','Diferencias','Ventas sin TAE del mes','% Merma / Vta sin TAE del Mes','Tipo Inventario','Resultado Inventarios Mayo','Resultado Inventarios Junio','Resultado Inventarios Julio','Resultado de Merma  (Final c/s proyectos)','Ventas Mayo','Ventas Junio','Ventas Julio','SUMA TOTAL VTA S/TAE','% Merma / Vta sin TAE (Final c/s proyectos)','Observaciones'],required:['CR','Tienda','Plaza','Asesor Comercial','Fecha de Inventario','Resultado de Inventario','Ventas sin TAE del mes'],filter:r=>containsOaxaca(r.Plaza),derive:deriveInventories,notes:'Resultados de Inventario Comercial. Detecta la hoja "Resultado de Inventario", genera Periodo como AAAA-MM desde el mes y ano del archivo (o desde la fecha del inventario como respaldo) y reemplaza solo el mes cargado, conservando los demas periodos.'}
  ];
};

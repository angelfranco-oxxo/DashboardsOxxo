...
(function () {
  ...
  const CONNECTIONS = [
    ...
    { id: 'd11', area: 'rh', title: 'Cumplimiento de marcajes', sheet: 'Dashboard_11_Semanal', origin: 'Excel Reporte Marcajes · Ranking por Tienda', frequency: 'Semanal', mode: 'Reemplaza toda la región · sin histórico', consumers: 'Dashboard 11 · Mi Tienda', copy: 'Publica la foto vigente de entradas, salidas y cumplimiento total para todas las plazas de la Región Tabasco; señala porcentajes mayores a 100%.' },
